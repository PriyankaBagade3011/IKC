...
--lr_min 0.0000001 \
--lr_scheduler multi \
--sftmd ckpt/sftmd/191119_x4_mutli_144_bs16_radam_ker21_aniso.pth \
--predictor ckpt/predictor/191119_x4_mutli_144_bs16_radam_ker21_aniso.pth \
--ckpt ckpt/corrector/191119_x4_multi_aniso_pair.pth \
--loss l2 \
--gpu 1 \
--optimizer radam \
